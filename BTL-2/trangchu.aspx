<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="trangchu.aspx.cs" Inherits="BTL_2.trangchu" %>
  ...
  <div class="wrap">
        ...
        <div class="grid wide">
            <header class="header">
                    ...
                    <div class="menu-content ">
                        <ul class="menu-content-lis ">
                            <li class="menu-content-items ">
                                <a href="#" class="menu-content-items-link active ">Trang Chủ</a>
                            </li>
                            <li class="menu-content-items ">
                ...
                <div class="header_text__logo ">
                    <a href="# " class="header_logo-link ">Fresh Organic</a>
                </div>
                <div class="header_nav ">
                    <ul class="header_nav-lis ">
                        <li class="header_nav-items ">
                            <a href="#" class="header_nav-items-link active ">Trang Chủ</a>
                        </li>
                        <li class="header_nav-items ">
        ...
        <div class="slider ">
            <div class="slider__wrapper ">
                <div class="slider__images-container ">
                    <img src="./images/img-slide/slideshow_1.jpg " alt=" ">
                    <img src="./images/img-slide/slideshow_2.jpg " alt=" ">
                    <img src="./images/img-slide/slideshow_3.jpg " alt=" ">
                </div>
            </div>
        ...
        <div class="banner-container ">
            <div class="banner-item ">
                <a href="producAll.aspx" class="banner-item-link">

                    <img src="./images/img-slide/home_category_1_banner.jpg " alt=" ">
                    <div class="banner-content ">
                        <h3>Sản Phẩm mới</h3>
                        <a href="productAll.aspx">
            ...
            <div class="banner-item ">
                <a href="producAll.aspx" class="banner-item-link">
                    ...
                    <img src="./images/img-slide/home_category_2_banner.jpg " alt=" ">
                    <div class="banner-content ">
                        <h3>Buổi trưa healthy</h3>
                         <a href="productAll.aspx">
                                  <button>  Xem Ngay  </button>
            ...
            <div class="banner-item ">
                <a href="producAll.aspx" class="banner-item-link">
                    ...
                    <img src="./images/img-slide/home_category_3_banner.jpg " alt=" ">
                    <div class="banner-content ">
                        <h3>Chế biến món ngon</h3>
                         <a href="productAll.aspx">
                                  <button>  Xem Ngay  </button>
            ...
            <div class="banner-item ">
                <a href="producAll.aspx" class="banner-item-link">
                    ...
                    <img src="./images/img-slide/home_category_4_banner.jpg " alt=" ">
                    <div class="banner-content ">
                        <h3>Món ngon buổi sáng</h3>
                        <a href="productAll.aspx">
                                  <button>  Xem Ngay  </button>
            ...
            <div class="banner-item ">
                <a href="producAll.aspx" class="banner-item-link">
                    ...
                    <img src="./images/img-slide/home_category_5_banner.jpg " alt=" ">
                    <div class="banner-content ">
        ...
        <div class="banner-2 ">
            <div class="row ">
                ...
                <div class="banner-2-item col l-4 m-12 c-12 ">
                    <a href="producAll.aspx">
                    <img src="./images/banner-2/block_home_category1.jpg" alt=" ">
                    </a>
                    <div class="banner-2-content ">
                        <span>Khuyến mãi tới 50%</span>
                        <h4>Món ngon buổi sáng</h4>
                        <a href="productAll.aspx">
                                  <button>  Xem Ngay  </button>
                ...
                <div class="banner-2-item col l-4 m-12 c-12 ">
                    <img src="./images/banner-2/block_home_category2.jpg " alt=" ">
                    <div class="banner-2-content ">
                        <span>BOUILLABAISSE</span>
                        <h4>SALAD KIỂU PHÁP</h4>
                        <a href="productAll.aspx">
                                  <button>  Xem Ngay  </button>
                ...
                <div class="banner-2-item col l-4 m-12 c-12 ">
                    <img src="./images/banner-2/block_home_category3.jpg " alt=" ">
                    <div class="banner-2-content ">
                        <span>Sản phẩm mới</span>
                        <h4>BUỔI SÁNG HEALTHY</h4>
            ...
            <div class="product-container ">
                ...
                <div class="introduce ">
                    <div class="introduce__img ">
                        <img src="./images/product-2/home_about_image.png " alt=" ">
                    ...
                    <div class="introduce__content ">
                        ...
                        <p>Bạn có thể chỉnh sửa hoặc xoá bài viết này tại <a href="https://fresh-organic-food.myharavan.com/adminv2/sale_channels/web/pages/1000592972
                        "><strong>đây</strong></a> hoặc thêm những bài viết mới trong phần quản lý <a href="https://fresh-organic-food.myharavan.com/adminv2/sale_channels/web/pages_new "><strong>Trang nội dung</strong></a>.</p>
                    </div>
